...
---
See also: [Network actions impact parameters](/docs/parameters#topological-actions-optimization), [Range actions impact parameters](/docs/parameters#range-actions-optimization)
